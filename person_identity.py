...
if st.button('Confirm'):
    ...
    if photo_doc is not None:
        ...
        web_photo = cam_image_load.image

        doc_descriptor = face_recognition.compute_face_descriptor(image_doc, shape_doc)
        cam_descriptor = face_recognition.compute_face_descriptor(web_photo, shape_cam)
        ...
        marked_face_cam = draw_facemask(web_photo, bbox_cam, shape_cam, bbox_color)
